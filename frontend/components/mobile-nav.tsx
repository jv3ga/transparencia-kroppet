...
export function MobileNav() {
  ...
  return (
    <>
      ...
      {open && (
        <div className="absolute top-full left-0 right-0 border-b border-border bg-background/95 backdrop-blur-sm shadow-lg z-50">
          <nav className="max-w-7xl mx-auto px-5 py-3 flex flex-col gap-1">
            ...
            <a
              ...
              onClick={() => setOpen(false)}
              className="text-sm px-3 py-2.5 rounded-md text-muted-foreground hover:text-foreground hover:bg-accent transition-colors flex items-center gap-2"
            >
